...
1. Creer un repertoire, puis se positionner dans ce repertoire (mkdir -p soutenance; cd soutenance)
2. Cloner le repository OCGames (git clone https://github.com/hervep530/OCGames)
3. Se positionner dans le repertoire OCGames (cd OCGames)
4. Creer un repertoire target (mkdir -p target)
...
Avant de relancer une éventuelle compilation, il est recommander de supprimer les fichiers .class (rm ./target/com/herve/ocgames/{*,*/*,*/*/*}.class)